                ...
                <Carousel responsive={responsives} infinite autoPlay={true} itemClass="px-2">
                    {TiposAventuras.map((item, index) => (
                        <div key={index} className="group">
                            <div className={`cursor-pointer p-8 rounded-lg flex flex-col justify-center items-start gap-4 ${currentSlide % TiposAventuras.length === index 
                                ...
                                <p className={`font-bold text-lg ${currentSlide % TiposAventuras.length === index
                                    ? 'text-white'
                                ...
                                <span className={`text-6xl ${currentSlide % TiposAventuras.length === index
                                    ? 'text-white'
                                    : 'text-blue1 group-hover:text-white'
                                    }`}>{item.icon}
                                </span>
                                ...
                                <p className={`${currentSlide % TiposAventuras.length === index
                                    ? 'text-white'
                                    : 'text-blue1 group-hover:text-white'}`} >Lorem ipsum dolor sit, amet consectetur 
                                </p>
